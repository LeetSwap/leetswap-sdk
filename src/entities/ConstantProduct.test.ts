import { FLEXUSD_ADDRESS, WCANTO_ADDRESS } from '../constants'
...
describe('computePoolAddress', () => {
  it('should correctly compute the pool address 2', () => {
    const tokenA = new Token(ChainId.CANTO, FLEXUSD_ADDRESS[ChainId.CANTO], 18, 'flexUSD', 'FlexUSD')
    const tokenB = new Token(ChainId.CANTO, WCANTO_ADDRESS[ChainId.CANTO], 18, 'BCH', 'Bitcoin Cash')
...
//             CurrencyAmount.fromRawAmount(WCANTO[3], '100')
//           )
//       ).toThrow('CHAIN_IDS')
//     })
//   })
